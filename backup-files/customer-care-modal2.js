...
var styles = 'div.logo-image { background: transparent url(https://ihg.scene7.com/is/image/ihg/uhf_ihg_logo@2x-1?fmt=png-alpha) no-repeat left center; background-size: 90px 36px; height: 90px; }';
styles += 'div.attention { color: #d96932; font-weight: bold; font-size: 20px; }';
styles += "p.reason { font-weight: bold; }";
styles += "div.modal-container { color: gray; padding: 20px; font-family: 'Graphik', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px;}";
styles += "li a { color: #d96932; }";
styles += "li { margin: 10px 0;}";
    ...
    if (typeof jQuery !== 'undefined') {
        setTimeout(function () {
            ...
            if (cookieVal !== 'true') {
                ...
                jQuery("<div/>").attr('id', 'modal-container').attr('class', 'modal-container').appendTo(jQuery('.modal-container-parent'));
