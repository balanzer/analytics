...
window.handleListHotelSpecifcMessage = function (hotelCode, listMessages) {
    ...
    try {
        ...
        if (null != hotelMessageContainer) {
            ...
            var hotelMessage = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>' + listMessages + '</p> ';
...
window.loadCovidBanner = function () {
    ...
    bannerMsg.USEN = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Existing bookings can be changed or cancelled for stays up to <strong>June 30, 2020.</strong><br>Some conditions apply, so please see <a href="' + bannerLinks.USEN + '" target="_blank"><font color="blue"><u>travel advisory</u></font></a> for full details and more information.</p>'
    bannerMsg.GBEN = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Existing bookings can be changed or cancelled for stays up to <strong>June 30, 2020.</strong><br>Some conditions apply, so please see <a href="' + bannerLinks.GBEN + '" target="_blank"><font color="blue"><u>travel advisory</u></font></a> for full details and more information.</p>'
    bannerMsg.USES = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Las reservas existentes se pueden cambiar o cancelar para estadías hasta el <strong>30 de junio de 2020;</strong> se aplican algunas condiciones, por lo que recomendamos que consulte los siguientes <a href="' + bannerLinks.USES + '" target="_blank"><font color="blue"><u>consejos sobre viajes</u></font></a> para obtener detalles completos y más información.</p>';
    bannerMsg.FRFR = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Les réservations en cours peuvent être modifiées ou annulées pour des séjours jusqu\'au <strong>30 juin 2020</strong>. Cette possibilité est assortie de conditions , merci de consulter la rubrique  <a href="' + bannerLinks.FRFR + '" target="_blank"><font color="blue"><u>conseils de voyage</u></font></a> pour obtenir toutes les précisions et pour plus d\'informations.</p>';
    bannerMsg.DEDE = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Bestehende Buchungen können für Aufenthalte bis zum <strong>30. Juni 2020 geändert oder storniert werden</strong>.Es gelten einige Bedingungen, deren Details Sie in unseren <a href="' + bannerLinks.DEDE + '" target="_blank"><font color="blue"><u>Reisehinweisen</u></font></a> nachlesen können.</p>';
    bannerMsg.ITIT = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Le prenotazioni esistenti possono essere modificate o cancellate per i soggiorni fino al <strong>30 giugno 2020</strong> - vigono alcune condizioni, pertanto consulta i <a href="' + bannerLinks.ITIT + '" target="_blank"><font color="blue"><u>consigli di viaggio</u></font></a> per i dettagli completi e per maggiori informazioni.</p>';
    bannerMsg.PTPT = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">As reservas existentes podem ser alteradas ou canceladas para estadas até  <strong>30 de junho de 2020</strong> – aplicam-se algumas condições, então confira a  <a href="' + bannerLinks.PTPT + '" target="_blank"><font color="blue"><u>consultoria de viagens</u></font></a> para obter detalhes completos e mais informações.</p>';
    bannerMsg.NLNL = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Bestaande boekingen kunnen worden gewijzigd of geannuleerd voor een verblijf tot  <strong>30 juni 2020</strong>  – er zijn enkele voorwaarden van toepassing, raadpleeg daarom het <a href="' + bannerLinks.NLNL + '" target="_blank"><font color="blue"><u>reisadvies</u></font></a> voor de volledige details en meer informatie.</p>';
    bannerMsg.RURU = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Существующие бронирования могут быть изменены или отменены для проживаний до   <strong>30 июня 2020 г</strong>.   - применяются некоторые условия, поэтому для получения более подробной информации см. <a href="' + bannerLinks.RURU + '" target="_blank"><font color="blue"><u>официальные предупреждения для туристов.</u></font></a> </p>';
    bannerMsg.JPJA = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"><strong>2020年6月30日までのご滞在につきましては、既存のご予約を変更またはキャンセルすることができます。</strong>いくつかの条件が適用される場合がありますので、詳細については <a href="' + bannerLinks.JPJA + '" target="_blank"><font color="blue"><u>渡航情報</u></font></a> をご確認ください。 </p>';
    bannerMsg.KRKO = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">기존 예약은  <strong>2020년 6월 30일</strong> 까지 변경하거나 취소할 수 있습니다. 몇 가지 조건이 적용되므로, <a href="' + bannerLinks.KRKO + '" target="_blank"><font color="blue"><u>더 자세한 내용은여행 권고 지침을 참고하시기 바랍니다.</u></font></a> </p>'
    bannerMsg.TRTR = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"><strong>30 Haziran 2020 tarihine kadarki konaklamalar için mevcut olan rezervasyonlar değiştirilebilir veya iptal edilebilir - belirli koşullar geçerlidir, tüm ayrıntılar ve daha fazla bilgi için, lütfen <a href="' + bannerLinks.TRTR + '" target="_blank"><font color="blue"><u>seyahat uyarısına</u></font></a> göz atın.</p>';
    bannerMsg.AEAR = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">يمكن تغيير أو إلغاء الحجوزات الحالية للإقامات حتى 30 يونيو 2020 - تُطبق بعض الشروط والأحكام، لذا يرجى الاطلاع على صفحة <a href="' + bannerLinks.AEAR + '" target="_blank"><font color="blue"><u>توصيات السفر</u></font></a>  لمعرفة التفاصيل الكاملة والمعلومات الإضافية.</p>';
    bannerMsg.THTH = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">การจองที่มีอยู่แล้วสามารถเปลี่ยนแปลงหรือยกเลิกได้สำหรับการเข้าพักจนถึงวันที่  <strong>30 มิถุนายน 2563</strong> - โดยมีเงื่อนไขบางประการ ดังนั้น โปรดดูในส่วน<a href="' + bannerLinks.THTH + '" target="_blank"><font color="blue"><u>ที่ปรึกษาการเดินทาง </u></font></a>สำหรับรายละเอียดทั้งหมดและข้อมูลเพิ่มเติม.</p>';
    bannerMsg.IDIN = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle">Pemesanan yang ada dapat diubah atau dibatalkan untuk masa inap hingga <strong>30 Juni 2020 </strong>- beberapa ketentuan berlaku, jadi silakan lihat <a href="' + bannerLinks.IDIN + '" target="_blank"><font color="blue"><u>nasihat perjalanan</u></font></a> untuk detail lengkap dan informasi lebih lanjut. </p>';
    bannerMsg.CNZH = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"></p>';
    bannerMsg.TWZH = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"></p>';
    /* End languages */
    ...
    setTimeout(function () {
        ...
        try {
            ...
            var hotelMessage = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"><span style="font-size:20px">&#9888;  </span>' + messgesHTML + '</p> ';
            ...
            if (location.pathname.indexOf("/find-hotels/select-room") > 0 || location.pathname.indexOf("/pay/reservation-view") > 0 || location.pathname.indexOf("/pay/confirmation") > 0) {
                hotelMessage = '<p style="display:table-cell; padding:10px; text-align:center; vertical-align:middle"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>' + messgesHTML + '</p>';
            }
            ...
            if (
                ...
                path.indexOf("stay-mgmt/reservation-cancellation") > -1 ||
...
if (
    ...
    path.indexOf("find-hotels/select-room") > -1 ||
    path.indexOf("stay-mgmt/ManageYourStay") > -1 ||
    path.indexOf("stay-mgmt/reservation-cancellation") > -1 || path.indexOf("/pay/confirmation") > -1 ||
